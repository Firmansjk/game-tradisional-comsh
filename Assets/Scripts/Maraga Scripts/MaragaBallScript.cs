...
public class MaragaBallScript : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject == char1)
        {
            ...
            maragaButtonControllerScript1.animasiMenendang = true;
            maragaButtonControllerScript2.animasiMenendang = false;
            maragaButtonControllerScript3.animasiMenendang = false;
            maragaButtonControllerScript4.animasiMenendang = false;
        ...
        if (collision.gameObject == char2)
        {
            ...
            maragaButtonControllerScript3.IdleAnimation();
            maragaButtonControllerScript4.IdleAnimation();
            maragaButtonControllerScript1.animasiMenendang = false;
            maragaButtonControllerScript2.animasiMenendang = true;
            maragaButtonControllerScript3.animasiMenendang = false;
            maragaButtonControllerScript4.animasiMenendang = false;
        ...
        if (collision.gameObject == char3)
        {
            ...
            maragaButtonControllerScript1.animasiMenendang = false;
            maragaButtonControllerScript2.animasiMenendang = false;
            maragaButtonControllerScript3.animasiMenendang = true;
            maragaButtonControllerScript4.animasiMenendang = false;
            char1.GetComponent<Collider2D>().enabled = true;
            char2.GetComponent<Collider2D>().enabled = true;
        ...
        if (collision.gameObject == char4)
        {
            ...
            maragaButtonControllerScript2.animasiMenendang = false;
            maragaButtonControllerScript3.animasiMenendang = false;
            maragaButtonControllerScript4.animasiMenendang = true;
            char1.GetComponent<Collider2D>().enabled = true;
            char2.GetComponent<Collider2D>().enabled = true;
            char3.GetComponent<Collider2D>().enabled = true;
